...
public:
	...
	void onSimulacionTerminada(const Cromosoma* c){
		...
		_regPob << "Punt. golpes: " + std::to_string(c->getMediaValores()[2]) + "(" + std::to_string(c->getMediaValores()[2] * c->getPesos()[2]) + " sobre el total)" << std::endl;
		...
		_regPob << "Punt. Andar Ataque: " + std::to_string(c->getMediaValores()[4]) + "(" + std::to_string(c->getMediaValores()[4] * c->getPesos()[4]) + " sobre el total)" << std::endl;
		_regPob << "Punt. distancia JyE: " + std::to_string(c->getMediaValores()[5]) + "(" + std::to_string(c->getMediaValores()[5] * c->getPesos()[5]) + " sobre el total)\n" << std::endl;
	}
