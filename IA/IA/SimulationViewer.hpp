...
private:
	...
	void onMapaTerminado(double fitness, double factorPatrulla, int cExpl, int cAndadas, int turnosQueValen, double factorAtaque, int cAndadasAtaque, int golpesEvitados, int golpes, int encontradoAtaque, int turnosAtaque, int intentos, double distancia, int turnosGolpeo) {
		std::string s = "Fitness = 1000 + factorPatrulla*(cExpl*0.1 + cAndadas*0.25 + turnosQueValen) + \n + factorAtaque^2*(cAndadasAtaque*0.25 + golpesEvitados + golpes + encontradoAtaque + turnosAtaque) - golpesFallados - distancia - turnosGolpeo \n";
		...
		s += ") + " + std::to_string(factorAtaque*factorAtaque) + "*(" + std::to_string(cAndadasAtaque) + "*0.25 + " + std::to_string(golpesEvitados) + " + " + std::to_string(golpes) + " + " + std::to_string(encontradoAtaque) + " + " + std::to_string(turnosAtaque) + ") - " + std::to_string(intentos) +" - "  + std::to_string(distancia) + " - " + std::to_string(turnosGolpeo);
